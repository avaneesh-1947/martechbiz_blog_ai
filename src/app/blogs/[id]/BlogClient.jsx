...
const BlogClient = ({ slug }) => {
  ...
  <div className="relative w-full overflow-hidden rounded-xl bg-gray-50 aspect-video">
    ...
    <div className='min-h-screen flex items-center justify-center bg-gradient-to-br from-[#e8f5f3] via-[#f0f9f7] to-[#e0f2f1]'>
      <div className='text-center'>
        <div className="relative w-16 h-16 mx-auto mb-6">
          <div className="absolute inset-0 bg-gradient-to-r from-[#40e0d0] to-[#20b2aa] rounded-full animate-ping opacity-30"></div>
          <div className="relative w-16 h-16 bg-gradient-to-r from-[#40e0d0] to-[#20b2aa] rounded-full flex items-center justify-center shadow-lg">
